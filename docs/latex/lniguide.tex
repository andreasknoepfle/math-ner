...
Eigennamenerkennung ist Bestandteil des Gebiets der Informationsextraktion und macht es möglich Entitäten wie Personen, Organisationen und Ortsnamen in unstrukturierten Texten zu erkennen. Die Erkennung der Eigennamen erhöht dabei die Nützlichkeit der Texte erheblich \cite[1]{bunescu2007learning}.
...
Auf eine Domäne spezialisierte Verfahren sind zudem in der Lage die domänenspezifischen Eigennamen zu klassifizieren. Beispielsweise gibt es im Bereich der Biologie bereits Systeme zur Eigennamenerkennung von Proteinnamen oder chemischen Termen \cite{altman2002pacific}. Ein domainenspezifisches System zur Eigennamenerkennung, funktioniert allerdings auch nur bedinngt in einer anderen Domäne.\\
...
Bevor die mathematische Eigennamen erkannt werden können, muss zunächst ein so genannter Korpus trainiert werden. Dafür benötigt man eine große Menge von Textdaten mit annotierten Eigennamen. Mit einem Korpus der auf diese Weise trainiert wurde kann man anschließen auch neue Texte annotieren. \\
\begin{figure}[ht!]
  \begin{center}
...
Der ''Lexical Parser'' führt zudem einen großen Rechenaufwand ein, durch was das Verfahren deutlich langsamer als die Erkennung durch maschinelles Lernen  wird. \\
